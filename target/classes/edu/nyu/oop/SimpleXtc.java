...
public class SimpleXtc extends Tool {
    ...
    public void init() {
        ...
        runtime.
                ...
                bool("importPackages", "importPackages", false, "Import Pacakges").
    ...
    public void process(Node node) {
        ...
        if(runtime.test("importPackages")){
            new Visitor() {
                public void visitImportDeclaration(GNode n) throws IOException{
                    Node k = n.getNode(1);
                    String file_path = k.getString(0)
                            +"/"+ k.getString(1)+"/"+k.getString(2)+".class";
