...
void __A::mmethod(A __this)
{std::cout << __rt::literal("A.m()")<< std::endl; 
}
A __A::mmethod__A(A __this, A a)
...
void __B::mmethod(B __this)
{std::cout << __rt::literal("B.m()")<< std::endl; 
}
A __B::mmethod__B(B __this, B b)
{std::cout << __rt::literal("B.m(B)")<< std::endl; 
return b; 
}
A __B::mmethod__A(B __this, A a)
...
a->__vptr->mmethod__A(a,a)->__vptr->mmethod(a); 
B b = __B::__init(new __B()); 
b->__vptr->mmethod__B(b,b)->__vptr->mmethod(b); 
b->__vptr->mmethod__A(b,(A ) b)->__vptr->mmethod(b); 
}
}
}
namespace __rt {
